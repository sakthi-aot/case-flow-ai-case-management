...
import { getCaseAdditionalDetails, getCaseDetails } from '../../../services/CaseService';
...
const CaseDetailReference = ({caseId} :CaseDetailReferenceProps ) => {
  ...
  return (
    ...
    {additionalCaseDetails ? <div className='configurable-case-content-section'><i>Configurable case content</i></div> : "" }
    </>
  )
}

    ...
    <>
      <form className="dashboard" onSubmit={handleSubmit(onSubmitHandler)}>
        ...
        <div className="lob-main-container">
          <div
            style={{ padding: "2rem 3rem 0rem 8rem" }}
            className="newOrupdateLobBlock"
          >
            <Typography
            ...
            <Grid container spacing={3} sx={{ padding: "2rem 1rem 2rem 1rem" }}>
              ...
              <Grid item xs={3}>
                <Controller
                  ...
                  control={control}
                  render={({
                    field: { onChange, value, ref, name, ...field },
                  }) => (
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      <DatePicker
                ...
                />
                <p className="policyExpDateError">
                  {errors.policyExpireDate &&
                    "* Policy Expire Date Cannot Be Before Policy Effective Date"}{" "}
                </p>
              </Grid>
            </Grid>

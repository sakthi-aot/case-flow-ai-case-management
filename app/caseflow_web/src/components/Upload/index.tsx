...
//upload file action
  const onSubmitHandler = async () => {
    ...
    if(values.documentID == 0) { // check with docid exist or not id documentID=0 insert opertaion work
    ...
    <>
      ...
      >
          <AccordionSummary
            ...
            className="acordions"
          >
            <Typography variant="h5">{values.documentID==0?"Upload File":"Update File"}</Typography>
          </AccordionSummary>
          <div className="DMS-selector">
            <Box sx={{ minWidth: 120, backgroundColor: "white" }}>
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={1}>Alfresco</MenuItem>
                  <MenuItem value={2}>S3</MenuItem>
                  <MenuItem value={3}>Share Point</MenuItem>
                </Select>
              </FormControl>
            </Box>
          </div>
          <AccordionDetails>
            <Typography>
              <div className="upload-grid">
               ...
               {values.documentID==0 && values.file && values.filetypeUploaded !== "plain" && (

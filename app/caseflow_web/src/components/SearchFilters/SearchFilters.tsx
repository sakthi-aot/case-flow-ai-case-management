...
const SearchFilters = () => {
    ...
    const filters = [
        ...
        {key : 3 , text : "Documents" , values : ["Documents 1","Documents 2","Documents 3"]},
        {key : 4 , text : "Line of Business" , values : ["LOB 1","LOB 2","LOB 3"]},
        {key : 5 , text : "Assigned By" , values : ["Assigned By 1","Assigned By 2","Assigned By 3"]},
                ...
                <FormControl sx={{ mt: 2, minWidth: 250 , border:0}} className="filters" size="small">
                    ...
                    >   
                        {item.values.map((values) => {
                            return (
                                <MenuItem value="Task 1">{values}</MenuItem>
                            )
                        })}
                    </Select>
                </FormControl>

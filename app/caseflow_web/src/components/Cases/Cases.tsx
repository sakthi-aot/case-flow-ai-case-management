...
const Cases = (
  ...
  const filterDocumentDetails = async () => {    
    let searchResult = await searchCases(searchField,searchColumn,selectedPage,sortSetting.orderBy,sortSetting.orderType,false,null,null)    
  ...
  const searchCasesDetails = async ()=>{
    ...
    let searchResult = await searchCases(searchField,searchColumn,selectedPage,sortSetting.orderBy,sortSetting.orderType,true,null,null)    
    let searchResultCases = searchResult.Cases?.map((element) => {

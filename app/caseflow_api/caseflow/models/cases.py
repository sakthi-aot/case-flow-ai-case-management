...
class Cases(BaseModel, db.Model):  # pylint: disable=too-many-public-methods
    ...
    statusid = db.Column(db.Integer(100), nullable=True)
    typeid = db.Column(db.Integer(100), nullable=True)
    linkedcases = db.Column(db.Integer(100), nullable=True)
    ...
    startuserid = db.Column(db.Integer(100), nullable=True)
    currentownerid = db.Column(db.Integer(100), nullable=True)
    involvedparties = db.Column(db.Integer(100), nullable=True)
